		...
		echo '<div class="gradient-form">';
				...
				echo '<div class="form-group color-picker has-addons has-addons-prepend">';
					echo '<div class="color-picker-group">';
						...
						echo '<div class="form-control has-icon has-icon-right">';
							if( $js ){
								echo '<input '. $this->get_name( $meta, 'color' ) .' class="mfn-form-control gradient-color mfn-form-input color-picker-vb" type="text" value="\'+('.$js.' && '.$js.'["color"] ? '.$js.'["color"] : "")+\'" autocomplete="off" data-key="color" />';
							}else{
			...
			echo '<div class="form-control">';
				...
				echo '<div class="form-group range-slider">';
					echo '<div class="form-control">';
						if( $js ){
							echo '<input '. $this->get_name( $meta, 'location' ) .' class="mfn-form-control mfn-form-input gradient-location mfn-sliderbar-value mfn-gradient-field" type="number" data-unit="" data-step="1" min="0" max="100" value="\'+('.$js.' && '.$js.'["location"] ? '.$js.'["location"] : "0")+\'" data-key="location">';
						}else{
			...
			echo '<div class="form-control">';
				...
				echo '<div class="form-group color-picker has-addons has-addons-prepend">';
					echo '<div class="color-picker-group">';
						...
						echo '<div class="form-control has-icon has-icon-right">';
							if( $js ){
								echo '<input '. $this->get_name( $meta, 'color2' ) .' class="mfn-form-control gradient-color2 mfn-form-input color-picker-vb" type="text" value="\'+('.$js.' && '.$js.'["color2"] ? '.$js.'["color2"] : "")+\'" autocomplete="off" data-key="color2" />';
							}else{
			...
			echo '<div class="form-control">';
				...
				echo '<div class="form-group range-slider">';
					echo '<div class="form-control">';
						if( $js ){
							echo '<input '. $this->get_name( $meta, 'location2' ) .' class="mfn-form-control mfn-form-input gradient-location2 mfn-sliderbar-value mfn-gradient-field" type="number" data-unit="" data-step="1" min="0" max="100" value="\'+('.$js.' && '.$js.'["location2"] ? '.$js.'["location2"] : "100")+\'" data-key="location2">';
						}else{
			...
			echo '<div class="form-control mfn-form-row" id="gradient-type'.$rand.'">';
				...
				echo '<div class="form-group">';
					echo '<select '. $this->get_name( $meta, 'type' ) .' class="mfn-form-control condition-field mfn-form-input gradient-type" data-key="type">';
						if( $js ){
			...
			echo '<div class="form-control mfn-form-row activeif activeif-gradient-type'.$rand.'" data-conditionid="gradient-type'.$rand.'" data-val="linear-gradient" data-opt="is">';
				...
				echo '<div class="form-group range-slider">';
					echo '<div class="form-control">';
						if( $js ){
							echo '<input '. $this->get_name( $meta, 'angle' ) .' class="mfn-form-control mfn-form-input gradient-angle mfn-sliderbar-value mfn-gradient-field" type="number" data-unit="" data-step="1" min="0" max="360" value="\'+('.$js.' && '.$js.'["angle"] ? '.$js.'["angle"] : "0")+\'" data-key="angle">';
						}else{
