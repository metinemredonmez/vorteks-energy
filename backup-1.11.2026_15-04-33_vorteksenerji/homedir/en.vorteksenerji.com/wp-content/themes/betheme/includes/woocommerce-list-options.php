<?php
    echo '<div class="mfn-woo-list-options">';
    	echo '<form class="mfn-before-products-list-form mfn_attr_filters" role="navigation" aria-label="attribute filters">';
		    ...
		    echo '<div class="mfn-woo-list mfn-woo-list-style">';
		    	...
		    	echo '<li '. ( $layout && $layout == 'list' ? 'class="active"' : null ).' role="link" tabindex="0"><input '. ( $layout && $layout == 'list' ? 'checked' : null ).' type="radio" name="mfn-shop" value="list"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" aria-label="list"><defs><style>.cls-1{opacity:0.2;}.path{fill:none;stroke-miterlimit:10;}</style></defs><g id="Layer_4" data-name="Layer 4"><rect class="path" x="2" y="2" width="12" height="12"/><line class="path" x1="2" y1="6" x2="14" y2="6"/><line class="path" x1="2" y1="10" x2="14" y2="10"/></g></svg></li> ';
		    	echo '</ul>';
		    echo '</div>';
			}
		echo '</form>';
